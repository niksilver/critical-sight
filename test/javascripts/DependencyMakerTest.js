define(['DependencyMaker', 'Sizer', 'Plan', 'PeriodMaker'], function(DependencyMaker, Sizer, Plan, PeriodMaker) {
	describe("DependencyMaker", function() {
		...
		describe("dependency", function() {
			...
			it("should give a shape within bounds for two tasks in direct sequence", function() {
				...
				var unitWidth = 50;
				var sizer = new Sizer(p, unitWidth, 10);
				var perMaker = new PeriodMaker(sizer);
	            var t1Rect = perMaker.taskRect(0, 0, 1);
	            var t2Rect = perMaker.taskRect(1, 1, 1);
	            var depMaker = new DependencyMaker(sizer);
